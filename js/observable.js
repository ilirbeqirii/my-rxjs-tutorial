...
var obs1 = new rxjs_1.Observable((subscriber) => {
    subscriber.next(1);
    subscriber.next(2);
    subscriber.next(3);
    subscriber.complete();
...
const obs2 = new rxjs_1.Observable((subscriber) => {
    subscriber.next(1);
    subscriber.next(2);
    subscriber.next(3);
    subscriber.complete();
...
const obs3 = new rxjs_1.Observable((subscriber) => {
    subscriber.next(1);
    setTimeout(() => {
...
const obs4 = new rxjs_1.Observable((subscriber) => {
    subscriber.next(1);
    subscriber.next(2);
    setTimeout(() => {
        try {
